...
(() => {
  ...
  const nav = [
    ...
    {key:"programs",label:"Programs",subs:[["Program Catalog","#program-catalog-panel"],["ReFuel",".refuel-admin-panel"]]},
  ...
  const workspaceMap = {
    ...
    programs:[document.getElementById("program-catalog-panel"),content.querySelector(".refuel-admin-panel")],
