...
(() => {
  ...
  const nav = [
    ...
    {key:"programs",label:"Programs",subs:[["Program Catalog","#program-catalog-panel"],["Access Rules","#program-access-panel"],["Content Library","#program-content-panel"],["ReFuel",".refuel-admin-panel"]]},
  ...
  const workspaceMap = {
    ...
    programs:[document.getElementById("program-catalog-panel"),document.getElementById("program-access-panel"),document.getElementById("program-content-panel"),content.querySelector(".refuel-admin-panel")],
