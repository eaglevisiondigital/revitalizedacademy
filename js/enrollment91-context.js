/* Build 91 — carry non-health Step 1 enrollment context into Step 2.
   Only identity/contact/routing context is stored in sessionStorage. No health-profile answers are stored. */
(() => {
  'use strict';
  ...
  form.addEventListener('submit', (event) => {
    ...
    try { sessionStorage.setItem('ra_enrollment_context_v2', JSON.stringify(context)); } catch (_) {}
  });
})();
